...
def parse_args():
    ...
    parser.add_argument('--num_group', type=int, default=128, help='point Number')
    parser.add_argument('--group_size', type=int, default=32, help='point Number')
    parser.add_argument('--exp_root', type=str, default='./log/', help='point Number')
...
def main(args):
    ...
    if 'pt' in args.model:
        classifier = MODEL.get_model(num_part, num_group=args.num_group, group_size=args.group_size).cuda()
    else:
