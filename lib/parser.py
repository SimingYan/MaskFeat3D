...
def get_args():
    ...
    args.experiment_path = os.path.join(args.exp_root, Path(args.config).stem, Path(args.config).parent.stem, args.exp_name)
    args.tfboard_path = os.path.join(args.exp_root, Path(args.config).stem, Path(args.config).parent.stem,'TFBoard' ,args.exp_name)
